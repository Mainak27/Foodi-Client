    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        ...
        <nav>
          ...
          <a className="link link-hover" href="https://forms.gle/9VtvpY51zy7BW9Ny8">mainak0310@gmail.com</a>
          <a className="link link-hover">+91 9834538923</a>
          <a className="link link-hover" href="https://github.com/Mainak27">Social media Handle</a>
        </nav>
      </footer>
        <hr />
